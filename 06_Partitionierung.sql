...
select * from ptab where nummer = 11
...
alter table ptab switch partition 1 to archiv--eigtl umbennen

100MB /SEK
100000000000000000000000000000MB --> Archiv
...
as
RANGE LEFT FOR VALUES('31.12.2020',--falsch  so korrekt31.12.2020 00:00:00.000 
					'31.12.2020 23.59:59.997', --richtig
					'','','','')

--A-M  N-R  S-Z

-------N]-----------------------------knallharte Grenzen keine WIldcard keine F()
...
create partition scheme schZahl
as
partition fzahl all to ([PRIMARY]) --macht durchaus Sinn
